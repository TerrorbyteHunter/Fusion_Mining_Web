...
import { db } from "./db";
import { users, userProfiles, adminAuditLogs, marketplaceListings, projects, messages, buyerRequests } from "@shared/schema";
  ...
  try {
    ...
    app.post('/api/login', async (req, res) => {
      ...
      if (!authenticatedUser) {
        console.warn('ΓÜá∩╕Å  WARNING: Using demo login endpoint - NOT FOR PRODUCTION USE');
